...
La funzione 'caricaModulo' ritorna una promise 
simulando il caricamento di un modulo con un ritardo di 2 secondi.
...
async function lanciaVeicoloSpaziale() {
  try {
    ...
    console.log("Errore durante il caricamento dei moduli: ", error);
  }
}
